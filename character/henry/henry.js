lf2.character.Henry = {
  ...
  frame: {
    ...
    'standing': {
      pic: ['0', 0, 0], wait: 3 * 4, next: 'standing2', move: [0, 0], center: [34, 79], flip: true,
      bdy: { x: 20, y: 10, w: 34, h: 67, },
      hit: {
        R: 'walking', L: 'walking', RR: 'running', LL: 'running', U: 'jump',
        B1: 'punch', B2: 'defend', B6: 'flute', B5: '', B4: 'super_arrow',
      },
    },
    'standing2': {
      pic: ['0', 0, 1], wait: 3 * 4, next: 'standing3', move: [0, 0], center: [34, 79], flip: true,
    ...
    'standing3': {
      pic: ['0', 0, 2], wait: 3 * 4, next: 'standing4', move: [0, 0], center: [34, 79], flip: true,
    ...
    'standing4': {
      pic: ['0', 0, 3], wait: 3 * 4, next: 999, move: [0, 0], center: [34, 79], flip: true,
    ...
    'walking': {
      pic: ['0', 0, 4], wait: 3 * 3, next: 'walking2', move: [5, 0], center: [35, 78], flip: true, hitHold: true,
    ...
    'walking2': {
      pic: ['0', 0, 5], wait: 3 * 3, next: 'walking3', move: [5, 0], center: [37, 79], flip: true, hitHold: true,
    ...
    'walking3': {
      pic: ['0', 0, 6], wait: 3 * 3, next: 'walking4', move: [5, 0], center: [39, 79], flip: true, hitHold: true,
    ...
    'walking4': {
      pic: ['0', 0, 7], wait: 3 * 3, next: 'walking', move: [5, 0], center: [40, 78], flip: true, hitHold: true,
    ...
    'running': {
      ...
      hit: {
        U: 'dash',
        B1: 'run_attack', B2: 'defend', B6: 'flute', B5: '', B4: 'super_arrow',
      },
    },
    'running2': {
    ...
    'run_attack': {
      pic: ['0', 3, 7], wait: 3 * 1, next: 'run_attack2', move: [5, 0], center: [42, 79],
      bdy: { x: 20, y: 8, w: 35, h: 71, },
    },
    'run_attack2': {
      pic: ['0', 2, 9], wait: 3 * 1, next: 'run_attack3', move: [4, 0], center: [15, 79],
      itr: { x: 106, y: 115, w: 1, h: 1, move: [10, 0], effect: 'injured', vrest: 15, injury: 35, },
      bdy: { x: 3, y: 12, w: 36, h: 67, },
    },
    'run_attack3': {
      pic: ['0', 3, 8], wait: 3 * 3, next: 'run_attack4', move: [4, 0], center: [15, 79], sound: '007.wav',
      itr: { x: 34, y: 4, w: 47, h: 89, move: [10, 0], effect: 'injured', vrest: 15, injury: 35, },
      bdy: { x: 5, y: 27, w: 43, h: 52, },
    },
    'run_attack4': {
      pic: ['0', 3, 9], wait: 3 * 2, next: 999, move: [0, 0], center: [15, 79],
      bdy: { x: 9, y: 19, w: 37, h: 61, },
    },

    'dash_attack': {
      pic: ['1', 3, 6], wait: 3 * 1, next: 'dash_attack2', move: [0, 0], center: [38, 77],
      bdy: { x: 20, y: 3, w: 31, h: 74, },
    },
    'dash_attack2': {
      pic: ['1', 3, 7], wait: 3 * 2, next: 'dash_attack3', move: [0, 0], center: [15, 78], sound: '007.wav',
      itr: { x: 27, y: 3, w: 50, h: 57, move: [12, 0], effect: 'injured', vrest: 20, injury: 45, },
      bdy: { x: 9, y: 7, w: 33, h: 70, },
    },
    'dash_attack3': {
      pic: ['1', 3, 8], wait: 3 * 0, next: 'dash_attack3', move: [0, 0], center: [15, 78],
      bdy: { x: 9, y: 7, w: 33, h: 70, },
    },

    'defend': {
      pic: ['0', 5, 6], wait: 3 * 12, next: 999, move: [0, 0], center: [37, 79], flip: true, hitHold: true,
    ...
    'jump': {
      pic: ['0', 6, 0], wait: 3 * 1, next: 'jump2', move: [0, 0], center: [33, 79], flip: true,
      bdy: { x: 18, y: 26, w: 30, h: 54, },
    },
    'jump2': {
      pic: ['0', 6, 1], wait: 3 * 1, next: 'jumping', move: [0, -9], center: [34, 79], sound: '017.wav', flip: true,
    ...
    'jumpingMove': {
      pic: ['0', 6, 2], wait: 3 * 1, next: 'jumping', move: [5, 0], center: [39, 79], flip: true,
    ...
    'dash': {
      pic: ['0', 6, 3], wait: 3 * 0, next: 'dash2', move: [9, -5], center: [39, 79],
    ...
    'injured': {
      pic: ['1', 5, 0], wait: 3 * 2, next: 'injured2', move: [0, 0], center: [47, 79],
      bdy: { x: 25, y: 17, w: 29, h: 61, },
    },
    'injured2': {
      pic: ['1', 5, 1], wait: 3 * 3, next: 999, move: [0, 0], center: [42, 79],
    ...
    'super_arrow': {
      pic: ['0', 1, 0], wait: 3 * 1, next: 'super_arrow2', move: [0, 0], center: [40, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow2': {
      pic: ['0', 1, 1], wait: 3 * 1, next: 'super_arrow3', move: [0, 0], center: [30, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow3': {
      pic: ['0', 1, 2], wait: 3 * 1, next: 'super_arrow4', move: [0, 0], center: [24, 78],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow4': {
      pic: ['2', 0, 4], wait: 3 * 1, next: 'super_arrow5', move: [0, 0], center: [38, 78], sound: '022.wav',
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow5': {
      pic: ['2', 0, 5], wait: 3 * 1, next: 'super_arrow8', move: [0, 0], center: [38, 78], sound: '059.wav',
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow6': {
      pic: ['2', 0, 5], wait: 3 * 1, next: 'super_arrow8', move: [0, 0], center: [38, 78],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow7': {
      pic: ['2', 0, 5], wait: 3 * 1, next: 'super_arrow8', move: [0, 0], center: [38, 78],
    ...
    'super_arrow9': {
      pic: ['2', 0, 7], wait: 3 * 1, next: 'super_arrow10', move: [0, 0], center: [36, 78],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'super_arrow10': {
      pic: ['0', 1, 5], wait: 3 * 1, next: 999, move: [0, 0], center: [36, 78],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
...
lf2.derivative.Henry = {
  ...
  frame: {
    ...
    'injured': {
      pic: ['arrow', 1, 0], wait: 3 * 0, next: 'in_the_sky2', move: [-4, -4], center: [24, 40], drop: 1000, physical: true,
    },
    'falling': {
      pic: ['arrow', 1, 0], wait: 3 * 0, next: 'in_the_sky2', move: [-4, -4], center: [24, 40], drop: 1000, physical: true,
    },
    ...
    'in_the_sky': {
      pic: ['arrow', 1, 0], wait: 3 * 0, next: 'in_the_sky2', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky2': {
      pic: ['arrow', 1, 1], wait: 3 * 0, next: 'in_the_sky3', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky3': {
      pic: ['arrow', 1, 2], wait: 3 * 0, next: 'in_the_sky4', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky4': {
      pic: ['arrow', 1, 3], wait: 3 * 0, next: 'in_the_sky5', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky5': {
      pic: ['arrow', 1, 4], wait: 3 * 0, next: 'in_the_sky6', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky6': {
      pic: ['arrow', 1, 5], wait: 3 * 0, next: 'in_the_sky7', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky7': {
      pic: ['arrow', 1, 6], wait: 3 * 0, next: 'in_the_sky8', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky8': {
      pic: ['arrow', 1, 7], wait: 3 * 0, next: 'in_the_sky9', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky9': {
      pic: ['arrow', 1, 8], wait: 3 * 0, next: 'in_the_sky10', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },
    'in_the_sky10': {
      pic: ['arrow', 1, 9], wait: 3 * 0, next: 'in_the_sky', move: [0, 0], center: [24, 40], drop: 1000, physical: true,
    },



    'SParrow': {
      pic: ['arrow2', 0, 0], wait: 3 * 1, next: 'SParrow2', move: [22, 0], center: [19, 24],
      itr: { x: -1, y: 12, w: 51, h: 24, move: [20, 0], effect: 'falling', vrest: 15, injury: 50, },
      bdy: { x: -1, y: 12, w: 51, h: 24, },
    },
    'SParrow2': {
      pic: ['arrow2', 0, 1], wait: 3 * 1, next: 'SParrow3', move: [22, 0], center: [19, 24],
      itr: { x: -1, y: 12, w: 51, h: 24, move: [20, 0], effect: 'falling', vrest: 15, injury: 50, },
      bdy: { x: -1, y: 12, w: 51, h: 24, },
    },
    'SParrow3': {
      pic: ['arrow2', 0, 2], wait: 3 * 1, next: 'SParrow4', move: [22, 0], center: [19, 24],
      itr: { x: -1, y: 12, w: 51, h: 24, move: [20, 0], effect: 'falling', vrest: 15, injury: 50, },
      bdy: { x: -1, y: 12, w: 51, h: 24, },
    },
    'SParrow4': {
      pic: ['arrow2', 0, 3], wait: 3 * 1, next: 'SParrow5', move: [22, 0], center: [19, 24],
      itr: { x: -1, y: 12, w: 51, h: 24, move: [20, 0], effect: 'falling', vrest: 15, injury: 50, },
      bdy: { x: -1, y: 12, w: 51, h: 24, },
    },
    'SParrow5': {
      pic: ['arrow2', 0, 4], wait: 3 * 1, next: 'SParrow6', move: [22, 0], center: [19, 24],
      itr: { x: -1, y: 12, w: 51, h: 24, move: [20, 0], effect: 'falling', vrest: 15, injury: 50, },
      bdy: { x: -1, y: 12, w: 51, h: 24, },
    },
    'SParrow6': {
      pic: ['arrow2', 0, 5], wait: 3 * 1, next: 'SParrow', move: [22, 0], center: [19, 24],
      itr: { x: -1, y: 12, w: 51, h: 24, move: [20, 0], effect: 'falling', vrest: 15, injury: 50, },
      bdy: { x: -1, y: 12, w: 51, h: 24, },
    },
