lf2.character.Firen = {
  ...
  frame: {
    ...
    'standing': {
      pic: ['0', 0, 0], wait: 4, next: 'standing2', move: [0, 0], center: [39, 79], flip: true,
    ...
    'standing4': {
      pic: ['0', 0, 3], wait: 5, next: 999, move: [0, 0], center: [39, 79], flip: true,
      bdy: { x: 21, y: 18, w: 43, h: 62, },
      hit: {
        R: 'walking', L: 'walking', RR: 'running', LL: 'running', U: 'jump',
        B1: 'punch', B2: 'defend', B6: 'explosion', B5: 'burn_run', B4: 'ball',
    ...
    'punch': {
      pic: ['0', 1, 0], wait: 2, next: 'punch2', move: [1, 0], center: [37, 79],
      itr: { x: 21, y: 57, w: 37, h: 24, vrest: 1, },
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'punch2': {
      pic: ['0', 1, 1], wait: 3, next: 999, move: [0, 0], center: [36, 79], sound: '007.wav',
      itr: { x: 33, y: 33, w: 42, h: 16, move: [2, 0], fall: false, arest: 10, injury: 20, },
      bdy: { x: 25, y: 11, w: 35, h: 69, },
    },

    'jump_attack': {
      pic: ['0', 1, 4], wait: 2, next: 'jump_attack2', move: [0, 0], center: [32, 75], sound: '007.wav',
      bdy: { x: 15, y: 10, w: 39, h: 63, },
    },
    'jump_attack2': {
      pic: ['0', 1, 5], wait: 3, next: 'jump_attack3', move: [0, 0], center: [33, 76],
      itr: { x: 30, y: 44, w: 42, h: 27, move: [7, 0], fall: true, arest: 15, injury: 35, },
      bdy: { x: 21, y: 14, w: 33, h: 57, },
    },
    'jump_attack3': {
      pic: ['0', 1, 6], wait: 5, next: 999, move: [0, 0], center: [35, 74],
      itr: { x: 28, y: 36, w: 44, h: 22, move: [7, 0], fall: true, arest: 15, injury: 35, },
      bdy: { x: 17, y: 13, w: 39, h: 58, },
    },

    'run_attack': {
      pic: ['1', 3, 2], wait: 1, next: 'run_attack2', move: [6, 0], center: [34, 79],
      bdy: { x: 19, y: 24, w: 35, h: 54, },
      bdy: { x: 10, y: 36, w: 27, h: 15, },
    },
    'run_attack2': {
      pic: ['1', 3, 3], wait: 1, next: 'run_attack3', move: [4, 0], center: [30, 79], sound: '007.wav',
      bdy: { x: 8, y: 51, w: 38, h: 27, },
      bdy: { x: 9, y: 8, w: 35, h: 47, },
    },
    'run_attack3': {
      pic: ['1', 3, 4], wait: 2, next: 'run_attack4', move: [0, 0], center: [28, 79],
      itr: { x: 29, y: 22, w: 47, h: 37, move: [10, 0], fall: true, arest: 15, injury: 50, },
      bdy: { x: 10, y: 59, w: 41, h: 24, },
      bdy: { x: 23, y: 19, w: 32, h: 37, },
    },
    'run_attack4': {
      pic: ['1', 3, 5], wait: 4, next: 999, move: [0, 0], center: [28, 79],
      itr: { x: 29, y: 22, w: 47, h: 37, move: [10, 0], fall: true, arest: 15, injury: 50, },
    ...
    'dash_attack': {
      pic: ['1', 3, 6], wait: 3, next: 'dash_attack2', move: [0, 0], center: [30, 78],
      bdy: { x: 24, y: 18, w: 25, h: 55, },
      bdy: { x: 13, y: 36, w: 52, h: 18, },
      bdy: { x: 31, y: 9, w: 25, h: 29, },
    },
    'dash_attack2': {
      pic: ['1', 3, 7], wait: 1, next: 'dash_attack3', move: [0, 0], center: [31, 78], sound: '007.wav',
      itr: { x: 27, y: 38, w: 53, h: 23, move: [12, 0], fall: true, arest: 20, injury: 70, },
      bdy: { x: 22, y: 40, w: 33, h: 26, },
      bdy: { x: 24, y: 6, w: 30, h: 34, },
    },
    'dash_attack3': {
      pic: ['1', 3, 8], wait: 3, next: 'dash3', move: [0, 0], center: [33, 77],
      itr: { x: 27, y: 38, w: 53, h: 23, move: [12, 0], fall: true, arest: 20, injury: 70, },
    ...
    'ball': {
      pic: ['2', 0, 0], wait: 1, next: 'ball2', move: [0, 0], center: [44, 79], sound: '067.wav',
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball2': {
      pic: ['2', 0, 1], wait: 1, next: 'ball3', move: [1, 0], center: [44, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball3': {
      pic: ['2', 0, 5], wait: 1, next: 'ball4', move: [0, 0], center: [31, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball4': {
    ...
    'ball5': {
      pic: ['2', 0, 3], wait: 1, next: 'ball6', move: [0, 0], center: [34, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball6': {
      pic: ['2', 0, 4], wait: 2, next: 999, move: [0, 0], center: [30, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
      hit: {
        B4: 'ball7',
      },
    ...
    'ball7': {
      pic: ['2', 0, 6], wait: 1, next: 'ball8', move: [0, 0], center: [30, 79], sound: '067.wav',
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball8': {
      pic: ['2', 0, 7], wait: 1, next: 'ball9', move: [0, 0], center: [30, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball9': {
      pic: ['2', 0, 8], wait: 1, next: 'ball10', move: [1, 0], center: [30, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball10': {
    ...
    'ball11': {
      pic: ['2', 1, 9], wait: 1, next: 'ball12', move: [0, 0], center: [32, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball12': {
      pic: ['2', 1, 8], wait: 2, next: 999, move: [0, 0], center: [30, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
      hit: {
        B4: 'ball13',
      },
    ...
    'ball13': {
      pic: ['2', 1, 7], wait: 1, next: 'ball14', move: [0, 0], center: [30, 79], sound: '067.wav',
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball14': {
      pic: ['2', 1, 6], wait: 1, next: 'ball15', move: [0, 0], center: [33, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball15': {
      pic: ['2', 1, 5], wait: 1, next: 'ball16', move: [1, 0], center: [34, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball16': {
    ...
    'ball17': {
      pic: ['2', 1, 3], wait: 1, next: 'ball18', move: [0, 0], center: [34, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },
    'ball18': {
      pic: ['2', 1, 2], wait: 2, next: 999, move: [0, 0], center: [32, 79],
      bdy: { x: 26, y: 12, w: 27, h: 68, },
    },


    'burn_run': {
      pic: ['2', 2, 3], wait: 2, next: 'burn_run2', move: [0, 0], center: [32, 79], sound: '003.wav',
      bdy: { x: 17, y: 15, w: 41, h: 62, },
    },
    'burn_run2': {
      pic: ['2', 2, 4], wait: 2, next: 'burn_run3', move: [10, 0], center: [36, 79], sound: '070.wav',
    ...
    'burn_run3': {
      ...
      itr: { x: 20, y: 11, w: 49, h: 70, move: [10, -10], fall: true, vrest: 10, injury: 45, },
    ...
    'stop_running': {
      pic: ['1', 4, 4], wait: 5, next: 999, move: [1, 0], center: [39, 79], sound: '009.wav',
    ...
    'explosion': {
      pic: ['2', 3, 5], wait: 1, next: 'explosion2', move: [0, 0], center: [43, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion2': {
      pic: ['2', 3, 6], wait: 1, next: 'explosion3', move: [0, 0], center: [43, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion3': {
      pic: ['2', 3, 7], wait: 1, next: 'explosion4', move: [0, 0], center: [43, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion4': {
      pic: ['2', 3, 8], wait: 1, next: 'explosion5', move: [0, 0], center: [43, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion5': {
    ...
    'explosion6': {
      pic: ['2', 3, 9], wait: 16, next: 'explosion7', move: [0, 0], center: [46, 79], sound: '020.wav',
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion7': {
      pic: ['2', 4, 9], wait: 1, next: 'explosion8', move: [0, 0], center: [46, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion8': {
      pic: ['2', 4, 8], wait: 1, next: 'explosion9', move: [0, 0], center: [43, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
    'explosion9': {
      pic: ['2', 3, 5], wait: 2, next: 999, move: [0, 0], center: [44, 79],
      bdy: { x: 8, y: 19, w: 41, h: 60, },
    },
...
lf2.derivative.Firen = {
  ...
  frame: {
    ...
    'standing': {
      pic: ['ball', 0, 0], wait: 1, next: 'flying2', move: [23, 0], center: [51, 41],
      itr: { x: 22, y: 27, w: 55, h: 27, move: [10, -10], fall: true, vrest: 10, injury: 45, next: 'falling', },
      bdy: { x: 22, y: 27, w: 55, h: 27, },
    },
    'flying2': {
      pic: ['ball', 0, 1], wait: 1, next: 'flying3', move: [23, 0], center: [53, 41],
      itr: { x: 22, y: 27, w: 55, h: 27, move: [10, -10], fall: true, vrest: 10, injury: 45, next: 'falling', },
      bdy: { x: 22, y: 27, w: 55, h: 27, },
    },
    'flying3': {
      pic: ['ball', 0, 2], wait: 1, next: 'flying4', move: [23, 0], center: [51, 41],
      itr: { x: 22, y: 27, w: 55, h: 27, move: [10, -10], fall: true, vrest: 10, injury: 45, next: 'falling', },
      bdy: { x: 22, y: 27, w: 55, h: 27, },
    },
    'flying4': {
      pic: ['ball', 0, 3], wait: 1, next: 'flying5', move: [23, 0], center: [54, 41],
      itr: { x: 22, y: 27, w: 55, h: 27, move: [10, -10], fall: true, vrest: 10, injury: 45, next: 'falling', },
      bdy: { x: 22, y: 27, w: 55, h: 27, },
    },
    'flying5': {
      pic: ['ball', 1, 0], wait: 1, next: 'flying6', move: [23, 0], center: [55, 41],
      itr: { x: 22, y: 27, w: 55, h: 27, move: [10, -10], fall: true, vrest: 10, injury: 45, next: 'falling', },
      bdy: { x: 22, y: 27, w: 55, h: 27, },
    },
    'flying6': {
    ...
    'falling': {
      pic: ['ball', 2, 0], wait: 1, next: 'hiting2', move: [0, 0], center: [40, 43],
    },
    'hiting2': {
      pic: ['ball', 2, 1], wait: 1, next: 'hiting3', move: [0, 0], center: [40, 42],
    },
    'hiting3': {
      pic: ['ball', 2, 2], wait: 1, next: 'hiting4', move: [0, 0], center: [44, 41],
    },
    'hiting4': {
      pic: ['ball', 2, 3], wait: 1, next: 1000, move: [0, 0], center: [52, 40],
    },
    ...
    'ground_fire3': {
      ...
      itr: { x: 0, y: 15, w: 36, h: 32, move: [-1, -6], fall: true, vrest: 20, injury: 20, },
    },
    'ground_fire4': {
    ...
    'explosion': {
      ...
      itr: { x: 23, y: 36, w: 112, h: 110, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion2': {
      pic: ['exp', 0, 1], wait: 1, next: 'explosion3', move: [0, 0], center: [78, 148],
      itr: { x: 20, y: 16, w: 122, h: 135, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion3': {
      pic: ['exp', 0, 2], wait: 1, next: 'explosion4', move: [0, 0], center: [78, 148],
      itr: { x: 19, y: 18, w: 127, h: 131, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion4': {
      pic: ['exp', 0, 3], wait: 1, next: 'explosion5', move: [0, 0], center: [78, 148],
      itr: { x: 7, y: 16, w: 146, h: 132, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion5': {
      pic: ['exp', 0, 4], wait: 1, next: 'explosion6', move: [0, 0], center: [78, 150],
      itr: { x: 13, y: 13, w: 137, h: 132, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion6': {
      pic: ['exp', 1, 0], wait: 1, next: 'explosion7', move: [0, 0], center: [78, 155],
      itr: { x: 7, y: 14, w: 145, h: 117, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion7': {
      pic: ['exp', 1, 1], wait: 1, next: 'explosion8', move: [0, 0], center: [78, 157],
      itr: { x: 15, y: 6, w: 128, h: 123, move: [-12, -18], fall: true, vrest: 300, injury: 125, symmetry: true, },
    },
    'explosion8': {
    ...
    'explosion10': {
      pic: ['exp', 1, 4], wait: 1, next: 'explosion11', move: [0, 0], center: [78, 177],
    },
    'explosion11': {
      pic: ['exp', 2, 0], wait: 1, next: 1000, move: [0, 0], center: [76, 172],
    },
