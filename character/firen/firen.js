lf2.character.Firen = {
  ...
  frame: {
    ...
    'standing': {
      pic: ['0', 0, 0], wait: 4, next: 'standing2', move: [0, 0], center: [39, 79],
    ...
    'standing2': {
      pic: ['0', 0, 1], wait: 6, next: 'standing3', move: [0, 0], center: [39, 79],
      bdy: { x: 21, y: 18, w: 43, h: 62, },
      hit: {
        R: 'walking', L: 'walking', RR: 'running', LL: 'running', U: 'jump',
        B1: 'punch', B2: 'defend', B6: 'explosion', B5: 'burnRun', B4: 'ball',
    ...
    'standing4': {
      pic: ['0', 0, 3], wait: 5, next: 999, move: [0, 0], center: [39, 79],
      bdy: { x: 21, y: 18, w: 43, h: 62, },
      hit: {
        R: 'walking', L: 'walking', RR: 'running', LL: 'running', U: 'jump',
        B1: 'punch', B2: 'defend', B6: 'explosion', B5: 'burnRun', B4: 'ball',
    ...
    'punch2': {
      ...
      itr: { x: 33, y: 33, w: 42, h: 16, move: [2, 0], injury: 20, },
    ...
    'dash_attack3': {
      pic: ['1', 3, 8], wait: 3, next: '216', move: [0, 0], center: [33, 77],
      itr: { x: 27, y: 38, w: 53, h: 23, move: [12, 0], fall: true, arest: 20, injury: 70, },
