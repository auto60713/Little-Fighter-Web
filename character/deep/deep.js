lf2.character.Deep = {
  ...
  frame: {
    ...
    'punch': {
      pic: ['0', 1, 0], wait: 6, next: 'punch2', move: [0, 0], center: [40, 79],
    ...
    'blast5': {
      pic: ['1', 6, 9], wait: 5, next: 999, move: [0, 0], center: [46, 79],
    ...
    'dash_sword2': {
      pic: ['2', 2, 1], wait: 3, next: 'dash_sword3', move: [6, 0], center: [18, 78], sound: '054.wav',
      bdy: { x: 3, y: 17, w: 19, h: 59, },
    },
    'dash_sword3': {
      pic: ['2', 2, 2], wait: 3, next: 'dash_sword4', move: [11, 0], center: [17, 78],
      itr: { x: 18, y: 18, w: 76, h: 62, move: [11, -2], effect: 'falling', vrest: 10, injury: 54, },
      bdy: { x: 2, y: 21, w: 18, h: 58, },
    },
    'dash_sword4': {
      pic: ['2', 2, 3], wait: 3, next: 'dash_sword5', move: [6, 0], center: [42, 78],
      itr: { x: -4, y: 47, w: 62, h: 24, move: [-7, 0], effect: 'injured', injury: 15, },
      bdy: { x: 20, y: 16, w: 20, h: 60, },
    },
    'dash_sword5': {
      pic: ['2', 2, 4], wait: 2, next: 'dash_sword6', move: [6, 0], center: [41, 78],
      bdy: { x: 25, y: 20, w: 16, h: 59, },
    },
    'dash_sword6': {
      pic: ['2', 2, 5], wait: 2, next: 'dash_sword7', move: [12, 0], center: [44, 78], sound: '054.wav',
      bdy: { x: 24, y: 15, w: 19, h: 64, },
    },
    'dash_sword7': {
      pic: ['2', 2, 6], wait: 3 * 1, next: 'dash_sword8', move: [6, 0], center: [26, 78],
      itr: { x: 2, y: 15, w: 90, h: 63, move: [8, -2], effect: 'falling', vrest: 10, injury: 42, },
      bdy: { x: 5, y: 16, w: 17, h: 63, },
    },
    'dash_sword8': {
      pic: ['2', 2, 7], wait: 3 * 1, next: 'dash_sword9', move: [6, 0], center: [19, 78],
      itr: { x: 43, y: 0, w: 46, h: 78, move: [8, -2], effect: 'falling', vrest: 10, injury: 42, },
      bdy: { x: 7, y: 12, w: 18, h: 65, },
    },
    'dash_sword9': {
      pic: ['2', 2, 8], wait: 2, next: 'dash_sword10', move: [6, 0], center: [26, 78],
      bdy: { x: 16, y: 14, w: 17, h: 63, },
    },
    'dash_sword10': {
      pic: ['2', 2, 9], wait: 3, next: 'dash_sword11', move: [12, 0], center: [19, 78], sound: '054.wav',
      bdy: { x: 7, y: 12, w: 18, h: 65, },
    },
    'dash_sword11': {
      pic: ['2', 3, 9], wait: 3, next: 'dash_sword12', move: [6, 0], center: [20, 78],
      itr: { x: 25, y: 4, w: 57, h: 77, move: [8, -2], effect: 'falling', vrest: 10, injury: 42, },
      bdy: { x: 9, y: 12, w: 15, h: 65, },
    },
    'dash_sword12': {
      pic: ['2', 3, 8], wait: 3 * 1, next: 'dash_sword13', move: [6, 0], center: [48, 78],
      itr: { x: 4, y: 38, w: 82, h: 39, move: [-8, 0], effect: 'injured', injury: 42, },
      bdy: { x: 36, y: 13, w: 17, h: 65, },
    },
    'dash_sword13': {
      pic: ['2', 3, 7], wait: 3 * 1, next: 'dash_sword14', move: [6, 0], center: [34, 78],
      bdy: { x: 23, y: 13, w: 22, h: 67, },
    },
    'dash_sword14': {
      pic: ['2', 3, 6], wait: 3 * 1, next: 'dash_sword15', move: [6, 0], center: [31, 78], sound: '054.wav',
      bdy: { x: 31, y: 11, w: 14, h: 69, },
    },
    'dash_sword15': {
      pic: ['2', 3, 5], wait: 3 * 1, next: 'dash_sword16', move: [6, 0], center: [10, 78],
      itr: { x: -4, y: 27, w: 99, h: 42, move: [11, -7], effect: 'falling', vrest: 10, injury: 48, },
      bdy: { x: 5, y: 19, w: 15, h: 63, },
    },
    'dash_sword16': {
      pic: ['2', 3, 4], wait: 3 * 1, next: 'dash_sword17', move: [12, 0], center: [14, 78],
      itr: { x: -6, y: 31, w: 98, h: 34, move: [11, -7], effect: 'falling', vrest: 10, injury: 48, },
      bdy: { x: 6, y: 13, w: 15, h: 69, },
    },
    'dash_sword17': {
      pic: ['2', 3, 3], wait: 3 * 1, next: 'dash_sword18', move: [0, 0], center: [42, 78],
      itr: { x: -11, y: 30, w: 102, h: 18, move: [-7, 0], effect: 'injured', injury: 20, },
      bdy: { x: 24, y: 30, w: 21, h: 48, },
    },
    'dash_sword18': {
      pic: ['2', 3, 2], wait: 3 * 1, next: 'dash_sword19', move: [0, 0], center: [42, 78],
      bdy: { x: 24, y: 22, w: 53, h: 58, },
    },
    'dash_sword19': {
      pic: ['2', 3, 1], wait: 3 * 1, next: 'dash_sword20', move: [0, 0], center: [34, 78],
      bdy: { x: 19, y: 17, w: 48, h: 62, },
    },
    'dash_sword20': {
      pic: ['2', 3, 0], wait: 3 * 2, next: 999, move: [0, 0], center: [35, 78],
    ...
    'jump_sword': {
      pic: ['2', 0, 0], wait: 3 * 1, next: 'jump_sword2', move: [5, 0], center: [29, 78],
      bdy: { x: 13, y: 20, w: 13, h: 60, },
    },
    'jump_sword2': {
      pic: ['2', 0, 1], wait: 3 * 1, next: 'jump_sword3', move: [0, 0], center: [26, 68], sound: '054.wav',
      itr: { x: 6, y: 39, w: 83, h: 28, move: [5, -8], effect: 'falling', vrest: 10, injury: 54, },
      bdy: { x: 12, y: 12, w: 20, h: 59, },
    },
    'jump_sword3': {
      pic: ['2', 0, 2], wait: 3 * 1, next: 'jump_sword4', move: [0, 0], center: [23, 74],
      itr: { x: 26, y: -1, w: 61, h: 75, move: [5, -8], effect: 'falling', vrest: 10, injury: 54, },
      bdy: { x: 11, y: 17, w: 17, h: 57, },
    },
    'jump_sword4': {
      pic: ['2', 0, 3], wait: 3 * 1, next: 'jump_sword5', move: [0, 0], center: [57, 76],
      itr: { x: -7, y: -10, w: 101, h: 37, move: [-9, 0], effect: 'falling', vrest: 10, injury: 18, },
      bdy: { x: 62, y: 24, w: 11, h: 47, },
    },
    'jump_sword5': {
      pic: ['2', 0, 4], wait: 3 * 1, next: 'jump_sword6', move: [0, 0], center: [57, 73],
      itr: { x: -7, y: 26, w: 51, h: 40, move: [-8, 0], effect: 'falling', vrest: 10, injury: 18, },
      bdy: { x: 59, y: 17, w: 16, h: 55, },
    },
    'jump_sword6': {
      pic: ['2', 1, 7], wait: 3 * 1, next: 'jump_sword7', move: [0, 0], center: [57, 78],
    ...
    'jump_sword7': {
      pic: ['2', 1, 6], wait: 3 * 1, next: 'jump_sword8', move: [0, 0], center: [48, 78],
    ...
    'jump_sword8': {
      pic: ['2', 1, 5], wait: 3 * 3, next: 999, move: [0, 0], center: [30, 79], U: 'jump_sword-8',
    ...
    // 跳
    'jump_sword9': {
      pic: ['2', 0, 5], wait: 3 * 1, next: 'jump_sword10', move: [5, -7], center: [50, 81], sound: '017.wav',
      bdy: { x: 28, y: 13, w: 53, h: 30, },
    },
    'jump_sword10': {
      pic: ['2', 0, 6], wait: 3 * 10, next: 'jump_sword10', move: [0, 0], center: [49, 80],
    ...
    // 跳攻
    'jump_sword11': {
      pic: ['2', 0, 7], wait: 3 * 1, next: 'jump_sword12', move: [0, -1], center: [52, 78],
      bdy: { x: 30, y: 14, w: 42, h: 28, },
    },
    'jump_sword12': {
      pic: ['2', 0, 8], wait: 3 * 1, next: 'jump_sword13', move: [0, 0], center: [51, 77], sound: '054.wav',
      itr: { x: 1, y: 5, w: 53, h: 20, move: [7, 12], effect: 'falling', vrest: 10, injury: 78, },
      bdy: { x: 30, y: 13, w: 41, h: 29, },
    },
    'jump_sword13': {
      pic: ['2', 0, 9], wait: 3 * 1, next: 'jump_sword14', move: [0, 1], center: [19, 75],
      itr: { x: 27, y: -2, w: 53, h: 63, move: [7, 12], effect: 'falling', vrest: 10, injury: 78, },
      bdy: { x: 3, y: 17, w: 29, h: 51, },
    },
    'jump_sword14': {
      pic: ['2', 1, 9], wait: 3 * 1, next: 'jump_sword15', move: [0, 0], center: [18, 74],
      itr: { x: 15, y: 39, w: 54, h: 43, move: [7, 12], effect: 'falling', vrest: 10, injury: 78, },
      bdy: { x: 4, y: 13, w: 32, h: 53, },
    },
    'jump_sword15': {
      pic: ['2', 1, 8], wait: 3 * 1, next: 'jump_sword15', move: [0, 0], center: [19, 72],
      bdy: { x: 3, y: 8, w: 30, h: 55, },
    },

    'jump_swordII': {
      pic: ['2', 1, 1], wait: 3 * 1, next: 'jump_swordII2', move: [5, 0], center: [12, 79],
      itr: { x: 0, y: 47, w: 81, h: 33, move: [5, -8], effect: 'falling', vrest: 10, injury: 60, },
      bdy: { x: 4, y: 19, w: 14, h: 58, },
    },
    'jump_swordII2': {
      pic: ['2', 1, 0], wait: 3 * 1, next: 'jump_swordII3', move: [0, 0], center: [12, 79], sound: '054.wav',
      itr: { x: 17, y: 15, w: 73, h: 55, move: [5, -8], effect: 'falling', vrest: 10, injury: 60, },
      bdy: { x: 4, y: 18, w: 17, h: 60, },
    },
    'jump_swordII3': {
      pic: ['2', 1, 2], wait: 3 * 1, next: 'jump_swordII4', move: [0, 0], center: [40, 80],
      itr: { x: 4, y: 2, w: 79, h: 39, move: [-5, -8], effect: 'falling', vrest: 10, injury: 30, },
      bdy: { x: 52, y: 21, w: 21, h: 61, },
    },
    'jump_swordII4': {
      pic: ['2', 1, 3], wait: 3 * 1, next: 'jump_swordII5', move: [0, 0], center: [40, 80],
      itr: { x: -8, y: 15, w: 49, h: 36, move: [-9, 0], effect: 'falling', vrest: 10, injury: 30, },
      bdy: { x: 54, y: 23, w: 17, h: 56, },
    },
    'jump_swordII5': {
      pic: ['2', 1, 4], wait: 3 * 1, next: 'jump_swordII6', move: [0, 0], center: [45, 79],
      bdy: { x: 37, y: 19, w: 30, h: 60, },
    },
    'jump_swordII6': {
      pic: ['2', 3, 0], wait: 3 * 2, next: 999, move: [0, 0], center: [36, 79],
...
lf2.derivative.Deep = {
  ...
  frame: {
    ...
    'hiting3': {
      pic: ['ball', 1, 2], wait: 3 * 1, next: 'hiting4', move: [0, 0], center: [37, 41],
    },
    'hiting4': {
